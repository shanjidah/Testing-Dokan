...
class VariableProductCest
{
   ...
   // tests
                                  ...
                                  \Page\Acceptance\ProductPage $product)
    {
      ...
      // $I->press('(//input[@type="search"])[5]','orange');
       $I->pressKey(['css' => '.select2-container--below .select2-search',WebDriverKeys::ENTER]);

       // $I->pressKey(['css' => '.select2-container--below .select2-search', 'orange', WebDriverKeys::ENTER]);
       // $I->appendField('(//input[@type="search"])[5]','green',WebDriverKeys::ENTER);
       $I->wait(4);
